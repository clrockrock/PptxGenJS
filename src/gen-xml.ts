		...
		switch (slideItemObj._type) {
			...
			case SLIDE_OBJECT_TYPES.placeholder:
				...
				if (slideItemObj.options.line) {
					...
					if (slideItemObj.options.line.fill) strSlideXml += genXmlColorSelection(slideItemObj.options.line.fill)
...
function genXmlTextRunProperties (opts: ObjectOptions | TextPropsOptions, isDefault: boolean): string {
	...
	if (opts.color || opts.fontFace || opts.outline || (typeof opts.underline === 'object' && opts.underline.color)) {
		...
		if (opts.color) runProps += genXmlColorSelection(typeof opts.color === 'object' ? opts.color : { color: opts.color, transparency: opts.transparency })
